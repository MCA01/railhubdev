      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            "Disclaimer: This is an unofficial example site built for educational purposes within our team. The original design is the property of raildevhub.pia-team.com"
            </p>
          </div>
